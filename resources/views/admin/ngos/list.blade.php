...
@section('content')
    <div class="bg-white rounded-lg shadow-sm">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <h3 class="text-sm text-gray-500 inline">List of all the verified NGOs</h3>
        </div>
                ...
                <tbody id="ngo-table-body" class="bg-white divide-y divide-gray-200">
                    ...
                    @forelse($ngos as $ngo)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{$ngo->ngo->category}}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{$ngo->ngo->address}}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{$ngo->ngo->registration_number}}
                            </td>
                        </tr>
